      ...
      <div className="max-w-lg mx-auto">
        ...
        >
          <div className="text-center">
            ...
            <h2 className="text-3xl font-serif text-gray-800 mb-3">Feres</h2>
            <div className="text-gray-600 text-sm mb-2">
              <p className="mb-1">[Nama Lengkap Mempelai Wanita]</p>
              <p>Putri dari:</p>
              <p className="font-medium mt-1">Bapak [Nama Ayah] & Ibu [Nama Ibu]</p>
            </div>
            
            {/* Instagram (optional) */}
            <div className="mt-4 pt-4 border-t border-gray-200">
              <a 
                href="https://instagram.com/feres"
                target="_blank"
        ...
        >
          <div className="text-center">
            ...
            <h2 className="text-3xl font-serif text-gray-800 mb-3">Yohanes</h2>
            <div className="text-gray-600 text-sm mb-2">
              <p className="mb-1">[Nama Lengkap Mempelai Pria]</p>
              <p>Putra dari:</p>
              <p className="font-medium mt-1">Bapak [Nama Ayah] & Ibu [Nama Ibu]</p>
            </div>
            ...
            <div className="mt-4 pt-4 border-t border-gray-200">
              <a 
                href="https://instagram.com/yohanes"
                target="_blank"
                rel="noopener noreferrer"
                className="text-emerald-600 hover:text-emerald-700 text-sm flex items-center justify-center gap-2"
              >
